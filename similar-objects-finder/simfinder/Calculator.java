...
public class Calculator {
    ...
    //Goes through each of the 'i' inputObjects in data and through each of their 'j' attributes checking if the target is equal to it
    ...
    public Map<String, Float> calculate(FieldValue[] target) {
        ...
        for(int i =0;i<data.size();i++){
            ...
            FieldValue [] currentData = data.get(i).getFields();
